        ...
        <div class="row d-flex justify-content-left">
            ...
            <div class="col-6 col-sm-3">
                <button class="btn btn-success my-4 px-3 mx-auto">
                    <a href="hojaDeTrabajo.php" class="text-warning">Verificacion</a>
                </button>
            </div>
            <div class="col-6 col-sm-3">
            ...
            <div class="row mx-0">
                <div class="col-10 col-sm-6">
                    ...
                    <label for="" class="text-warning">⚠ Si desea subir de un archivo CSV separado por comas, por favor
                        siga el orden de la tabla (id-empleado, nombre, fecha, estado)</label>
                </div>
                <div class="col-10 col-sm-6 mt-sm-0 mt-3">
